...
class TestSpaceevalConllReader:
    def test_read_from_file(self):
        ...
        expected_tokens = ["Bunchrew", "had", "a", "station", "on", "the",
                           "Inverness", "and", "Ross", "-", "shire",
                           "Railway", "."]
        expected_tags = ('U-PLACE_NAM', 'O', 'O',
                         'U-PLACE_NOM', 'O', 'O',
                         'B-PLACE_NAM', 'I-PLACE_NAM',
                         'I-PLACE_NAM', 'I-PLACE_NAM',
                         'I-PLACE_NAM', 'L-PLACE_NAM', 'O')

        assert [t.text for t in fields["tokens"].tokens] == expected_tokens
        assert fields["tags"].labels == expected_tags
